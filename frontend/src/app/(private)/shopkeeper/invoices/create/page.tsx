        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-blue-50 pb-24">
            ...
            <div className="p-4 md:p-6">
                ...
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    {/* Notes & Terms - Enhanced Design */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {/* Notes Card */}
                        <Card className="border-0 shadow-xl overflow-hidden bg-white">
                            <CardHeader className="border-b-2 border-amber-500 bg-gradient-to-r from-amber-50 to-yellow-50 pb-5">
                                <div className="flex items-center gap-3">
                                    <div className="p-2.5 bg-gradient-to-br from-amber-600 to-yellow-600 rounded-xl shadow-lg">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-gray-600 mt-0.5">
                                            {t('invoices.notes_subtitle')}
                                        </p>
                                    </div>
                                    <Badge variant="secondary" className="text-xs">{t('invoices.optional')}</Badge>
                                </div>
                            </CardHeader>
                            <CardContent className="p-5">
                                <div className="space-y-2">
                                    <Label htmlFor="notes" className="text-xs font-bold text-gray-700 flex items-center gap-2">
                                        <div className="w-1.5 h-3 bg-amber-500 rounded-full"></div>
                                        {t('invoices.notes_content')}
                                    </Label>
                                    <Textarea
                                        id="notes"
                                        ...
                                        rows={5}
                                        className="text-sm border-2 border-gray-200 focus:border-amber-500 rounded-xl resize-none bg-white transition-all font-medium leading-relaxed"
                                    />
                                </div>
                                <div className="mt-4 p-3 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg border border-amber-100">
                                    <p className="text-xs text-gray-600 flex items-start gap-2">
                                        <span className="text-amber-600">💡</span>
                                        <span className="flex-1">{t('invoices.notes_tip')}</span>
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        {/* Terms Card */}
                        <Card className="border-0 shadow-xl overflow-hidden bg-white">
                            <CardHeader className="border-b-2 border-teal-500 bg-gradient-to-r from-teal-50 to-cyan-50 pb-5">
                                <div className="flex items-center gap-3">
                            ...
                            <CardContent className="p-5">
                                <div className="space-y-2">
                                    <Label htmlFor="terms" className="text-xs font-bold text-gray-700 flex items-center gap-2">
                                        <div className="w-1.5 h-3 bg-teal-500 rounded-full"></div>
                                        {t('invoices.terms_content')}
                                    </Label>
                                    <Textarea
                                        id="terms"
                                        ...
                                        rows={5}
                                        className="text-sm border-2 border-gray-200 focus:border-teal-500 rounded-xl resize-none bg-white transition-all font-medium leading-relaxed"
                                    />
                                </div>
                                <div className="mt-4 p-3 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg border border-teal-100">
                                    <p className="text-xs text-gray-600 flex items-start gap-2">
                                        <span className="text-teal-600">📋</span>
                                        <span className="flex-1">{t('invoices.terms_tip')}</span>
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
            ...
            <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
                <DialogContent className="w-[95vw] max-w-[95vw] lg:w-[60vw] lg:max-w-[60vw] max-h-[95vh] p-0 gap-0 flex flex-col bg-gradient-to-br from-gray-50 to-blue-50/30">
                    {/* Enhanced Header */}
                    <DialogHeader className="px-6 py-5 border-b bg-gradient-to-r from-purple-600/5 via-blue-600/5 to-indigo-600/5 backdrop-blur-sm flex-shrink-0">
                        <div className="flex items-center justify-between flex-wrap gap-3">
                            <div className="flex items-center gap-3">
                                <div className="p-2.5 bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl shadow-lg">
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                                <Badge className="bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 border-blue-200">
                                    ...
                                    {t(`invoices.templates.${formData.templateId || 'modern'}`)}
                                </Badge>
                                <Badge className="bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 border-purple-200">
                                    <Palette className="h-3 w-3 mr-1" />
                                    {t(`invoices.colors.${formData.colorScheme || 'blue'}`)}
                                </Badge>
                            </div>
                        </div>
                    </DialogHeader>
                    ...
                    <div className="flex-1 overflow-y-auto px-6 py-6 bg-white/50">
                        <div className="w-full mx-auto">
                            {/* Invoice Preview with Shadow */}
                            <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden transform transition-all hover:shadow-3xl">
                                <InvoicePreview
                                    invoice={{
                                        ...formData,
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-semibold text-blue-900 mb-1">
                                            {t('invoices.looking_perfect')}
                                        </p>
                                        <p className="text-xs text-blue-700 leading-relaxed">
                                            {t('invoices.looking_perfect_desc')}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="px-6 py-5 border-t bg-gradient-to-r from-gray-50 to-blue-50/30 backdrop-blur-sm flex-shrink-0">
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-white rounded-lg border border-gray-200 shadow-sm">
                                    <div className="text-xs text-gray-600">{t('invoices.total_amount')}:</div>
                            ...
                            <div className="flex items-center gap-3">
                                <Button
                                    ...
                                    className="flex-1 sm:flex-none h-11 border-2 hover:border-gray-400 hover:bg-gray-50 font-semibold gap-2"
                                >
                                    <ArrowLeft className="h-4 w-4" />
                                    {t('common.back')}
                                </Button>
                                ...
                                <Button
                                    onClick={() => { setPreviewOpen(false); handleSubmit('sent'); }}
                                    disabled={createMutation.isPending}
                                    className="flex-1 sm:flex-none h-11 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 hover:from-purple-700 hover:via-blue-700 hover:to-indigo-700 text-white font-bold shadow-lg hover:shadow-xl transition-all gap-2"
                                >
                                    {createMutation.isPending ? (
                                        <>
                        ...
                        {/* Mobile Total (shown only on mobile) */}
                        <div className="sm:hidden mt-3 p-3 bg-white rounded-lg border border-gray-200 shadow-sm">
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-gray-600">{t('invoices.total_amount')}:</span>
